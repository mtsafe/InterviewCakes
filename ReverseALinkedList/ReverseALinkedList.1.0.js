...
function reverse(headOfList) {
  ...
  let tailofList, remainderList, tmpList
  remainderList = headOfList.next
  tailofList = null
  while (remainderList !== null) {
    tmpList = remainderList.next
    remainderList.next = tailofList
    tailofList = remainderList
    remainderList = tmpList
  }

  return tailofList === null ? headOfList : tailofList
}
